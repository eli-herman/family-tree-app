...
must_haves:
  truths:
    ...
    - "useFamilyStore.calculateRelationship('shelby') returns 'Your Mom'"
...
interface FamilyState {
  ...
  calculateRelationship: (targetId: string) => string;
...
- Get current user ID from userStore (import and call)
- If no current user, return 'Unknown'
...
6. Verify useFamilyStore.getState().calculateRelationship('shelby') returns "Your Mom"
</verification>
...
- calculateRelationship uses currentMemberId from userStore
</success_criteria>
